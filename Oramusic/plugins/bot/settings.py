...
from Oramusic.utils.decorators.admins import ActualAdminCB
from Oramusic.utils.decorators.language import language, languageCB
from Oramusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from Oramusic.utils.inline.start import private_panel
